...
app.post("/home-guest", function (req, res) {
...
app.post('/checkoutRTGuest', function(req, res){
  ...
  var req = https.request(options, function (response1) {
    ...
    response1.on("end", function (chunk) {
      ...
      res.render("guest/checkoutRTGuest", {
        idOfOffer: idOfOffer,
        body2: body2
      });
    });
...
app.post('/checkoutOWGuest', function(req, res){
  ...
  var req = https.request(options, function (response1) {
    ...
    response1.on("end", function (chunk) {
      ...
      res.render("guest/checkoutOWGuest", {
        idOfOffer: idOfOffer,
        body2: body2
      });
    });
